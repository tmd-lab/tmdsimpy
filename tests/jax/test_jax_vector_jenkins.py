...
# vectorized JAX version
from tmdsimpy.jax.nlforces.vector_jenkins import VectorJenkins
...
class TestJAXJenkins(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.ref_jenkins = JenkinsForce(Q, T, kt, Fs, u0=None)
        self.jenkins_force = VectorJenkins(Q, T, kt, Fs, u0=None)
        ...
        self.jenkins_force2 = VectorJenkins(Q, T, kt, Fs, u0=np.array([0.0]))
        self.jenkins_force3 = VectorJenkins(Q, T, kt, Fs, u0=np.array([0.2]))
    ...
    def test_vec_jenk1(self):
        ...
        FnlH_vec, dFnldUH_vec, dFnldw_vec = ref_jenkins.aft(Unl, w, h, Nt=Nt)
